...
class GameMap:
    ...
    def make_map(self, max_rooms, room_min_size, room_max_size, map_width, map_height, player, entities,
        ...
        down_stairs = Entity(center_of_last_room_x, center_of_last_room_y, constants['stairsdown_tile'], libtcod.white,
                             'Stairs', render_order=RenderOrder.STAIRS, stairs=stairs_component)
        entities.append(down_stairs)

    def create_room(self, room):
        # go through the tiles in the rectangle and make the passable
